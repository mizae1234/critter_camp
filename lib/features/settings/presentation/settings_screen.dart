...
class SettingsScreen extends StatefulWidget {
  ...
  final VoidCallback? onOpenWelcomeScreen;
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget build(BuildContext context) {
    final String lastSync = widget.storage.getLastSyncTime() != null
        ...
        : (AppStrings.isThai ? 'บันทึกในอุปกรณ์แล้ว' : 'Synced with device storage');
          ...
          SafeArea(
            child: ListView(
              ...
              children: [
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        subtitle: const Text('Display in English (Default)', style: TextStyle(fontSize: 12)),
                      ...
                      ListTile(
                        ...
                        subtitle: const Text('แสดงผลภาษาไทยแบบทันที', style: TextStyle(fontSize: 12)),
                ...
                // Section 3: Cloud & Account Portal
                ...
                CritterCard(
                  ...
                  child: Column(
                    children: [
                      if (widget.onOpenWelcomeScreen != null) ...[
                        ListTile(
                          leading: const Text('⛺', style: TextStyle(fontSize: 22)),
                          title: Text(AppStrings.openWelcomeScreen, style: const TextStyle(fontWeight: FontWeight.w700)),
                          subtitle: Text(AppStrings.openWelcomeScreenSub, style: const TextStyle(fontSize: 12)),
                          trailing: const Icon(Icons.chevron_right_rounded, color: AppColors.primary),
                          onTap: widget.onOpenWelcomeScreen,
                        ),
                        const Divider(height: 1, indent: 16, endIndent: 16),
                      ],
                      ListTile(
                        leading: const Icon(Icons.cloud_sync_rounded, color: AppColors.primary),
                        title: Text(AppStrings.cloudSyncStatus),
                                ...
                                onPressed: () async {
                                  if (widget.syncService != null) {
                                    ...
                                    messenger.showSnackBar(
                                      SnackBar(content: Text(AppStrings.syncCompleted)),
                                    );
                                  }
                                },
                              ),
